...
public class ViewDirectors {
    ...
    public void buildData() {
        ...
        try {
            CallableStatement cstmt = conn.prepareCall("{? = call lista_directors ()}");
            ...
            for (int i = 0; i < rs.getMetaData().getColumnCount(); i++) {
                ...
                directorsTable.getColumns().addAll(col);
